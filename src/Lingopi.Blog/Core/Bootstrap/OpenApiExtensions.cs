namespace Lingopi.Blog.Core.Bootstrap;
...
public static class OpenApiExtensions
{
    ...
    public static void UseConfiguredSwagger(this WebApplication app)
    {
        ...
        {
            configs.DocumentTitle = "Swagger UI - Lingopi Blog API";
            configs.SwaggerEndpoint($"/openapi/{DocumentTitle}.json", "Lingopi API - Blog");
        });
    }
}